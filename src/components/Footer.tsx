  ...
  <footer className="bg-primary text-primary-foreground">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-primary-foreground/70">
            <li className="flex items-start gap-2">
              ...
              <span>123 Industrial Area, Ahmedabad, Gujarat 380015, India</span>
            </li>
    ...
    <div className="border-t border-primary-foreground/10">
      <div className="container-main py-4 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-primary-foreground/50">
        <p>© {new Date().getFullYear()} Avon Pharmo Chem Pvt Ltd. All rights reserved.</p>
